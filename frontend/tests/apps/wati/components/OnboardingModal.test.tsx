...
import { OnboardingModal } from '@wati/src/components/OnboardingModal';
...
vi.mock('@wati/src/AuthContext', async () => {
    const actual: any = await vi.importActual('@wati/src/AuthContext');
    return {
        ...actual,
        useAuth: () => ({
            user: mockUser,
